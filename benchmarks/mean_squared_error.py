...
from torcheval.metrics import MeanSquaredError, Metric
...
def main(num_batches, batch_size, compute_interval, use_torchmetrics):
    ...
    rank_0_print(f"Benchmark MeanSquaredError...")
    if use_torchmetrics:
        metric = tmMeanSquaredError().to(device)
    else:
...
if __name__ == "__main__":
    print("Benchmark MeanSquaredError metrics...")
